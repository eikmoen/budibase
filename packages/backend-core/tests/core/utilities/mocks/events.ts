beforeAll(async () => {
  ...
  jest.spyOn(events.workspace, "created")
  jest.spyOn(events.workspace, "updated")
  jest.spyOn(events.workspace, "duplicated")
  jest.spyOn(events.workspace, "deleted")
  jest.spyOn(events.workspace, "published")
  jest.spyOn(events.workspace, "unpublished")
  jest.spyOn(events.workspace, "templateImported")
  jest.spyOn(events.workspace, "fileImported")
  jest.spyOn(events.workspace, "versionUpdated")
  jest.spyOn(events.workspace, "versionReverted")
  jest.spyOn(events.workspace, "reverted")
  jest.spyOn(events.workspace, "exported")
